...
?>
    ...
    <body>
        ...
        <div class="container branchesContainer">
            ...
            if (isset($_GET['id'])) {
                $branche_id = mysqli_real_escape_string($conn, $_GET['id']);
                $sql = "SELECT * FROM branches WHERE user_id ='$id' and id='$branche_id'";
            ...
            ?>
                    <div class="row branchInfo">
                        <div class="col-5 formContainer">
                            ...
                            <form action="brances_process.php" method="POST">
                                <legend>Update Branche</legend>
                                <div class="filed">
                                    <input type="hidden" name="id" value="<?= $branche_id; ?>">
                                ...
                                <div class="filed">
                                    ...
                                    <input type="text" name="manager_name" placeholder="Optional" value="<?= $branch['manager_name']; ?>">
                                </div>
                                <div class="filed">
                                    <label>Contact Number </label>
                                    <input type="text" name="contact_number" placeholder="Optional" value="<?= $branch['contact_number']; ?>">
                                </div>

                                <div class="btn ">
                                    <button class="btn btn-outline-light" name="update" type="submit">Update Branche</button>
                                </div>
                            </form>
                    <?php
                }
